...
export const defaultTwitchAdvancedConfig: TwitchAdvancedConfig = {
  ...
  commands: [
    ...
    },
    {
      ...
      name: "About Command",
      trigger: "!about",
      response: "I'm an AI agent powered by Phantasy. Ask me anything or just chat. 🤖",
      cooldown: 15,
      modOnly: false,
      subOnly: false,
      enabled: true,
    },
    {
      ...
      name: "Social Links",
      trigger: "!socials",
      response: "Follow us on Twitter and join our Discord! Links in the about section.",
      cooldown: 30,
      modOnly: false,
      subOnly: false,
      enabled: true,
